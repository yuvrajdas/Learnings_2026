...
search_terms = ["Angular Developer", "React Developer", "UI Developer", "Front End Developer", "Web Developer"]
...
experience_level = ["Mid-Senior level", "Associate"]              # (multiple select) "Internship", "Entry level", "Associate", "Mid-Senior level", "Director", "Executive"
...
location = ["India"]               # (dynamic multiple select) keep this aligned with `search_location`
